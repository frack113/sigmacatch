...
> **Note:** With the single-package layout, commit messages may use module-based prefixes (e.g., `inputs:`, `runner:`, `detection:`, `regression:`, `repo:`, `rule:`) instead of the old crate-based prefixes (`sigmacatch-runner:`, `sigmacatch-detection:`, etc.).

Exception: regression data commits generated by the pipeline use
`🧪 test: add regression data for rule {id}`.
