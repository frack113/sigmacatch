...
use super::filekey::FileKeyTable;
use super::filetime_quad_to_sysmon_utc;
use super::paths;
use super::pe::PeInfo;
use super::process_query;
use super::process_table::{ProcessEnrichment, ProcessTable};
use super::sysmon;
...
impl EnrichState {
    pub fn new() -> Self {
        ...
        let process_table = super::process_table::snapshot();
...
impl EnrichState {
    ...
    fn insert_pe_fields(&mut self, image: &str, fields: &mut HashMap<String, String>) {
        let info = self.pe_cache.get(image).or_else(|| {
            let info = super::pe::pe_info(image)?;
