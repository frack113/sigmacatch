...
Le projet est un cargo workspace de 12 packages ; l'arborescence complète et les rôles de
chaque crate sont détaillés dans [architecture.md](architecture.md).
