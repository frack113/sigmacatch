...
**File:** `localcheck/src/check_dry_run.rs`
...
Accepts the same flags as the main binary (`--author`, `--offline`, `--contrib`, `--help`).
...
**File:** `localcheck/src/check_channels.rs`
...
**File:** `localcheck/src/list_rules.rs`
