...
use crate::repo::plumbing::refs::{map_grit, read_loose_or_packed_ref, resolve_head};
...
mod tests {
    use super::*;
    use crate::repo::plumbing::read_loose_or_packed_ref;
    use crate::repo::plumbing::refs::symbolic_ref_target;
